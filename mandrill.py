...
class Messages(object):
    ...
    def send(self, message, async_bool=False, ip_pool=None, send_at=None):
        ...
        Args:
           ...
           async_bool (boolean): enable a background sending mode that is optimized for bulk sending. In async_bool mode, messages/send will immediately return a status of "queued" for every recipient. To handle rejections when sending in async_bool mode, set up a webhook for the 'reject' event. Defaults to false for messages with no more than 10 recipients; messages with more than 10 recipients are always sent async_boolhronously, regardless of the value of async_bool.
        ...
        Raises:
           ...
           Error: A general Mandrill error has occurred
        """
        _params = {'message': message, 'async_bool': async_bool, 'ip_pool': ip_pool, 'send_at': send_at}
        return self.master.call('messages/send', _params)

    def send_template(self, template_name, template_content, message, async_bool=False, ip_pool=None, send_at=None):
        ...
        Raises:
           ...
           Error: A general Mandrill error has occurred
        """
        _params = {'template_name': template_name, 'template_content': template_content, 'message': message, 'async_bool': async_bool, 'ip_pool': ip_pool, 'send_at': send_at}
    ...
    def send_raw(self, raw_message, from_email=None, from_name=None, to=None, async_bool=False, ip_pool=None, send_at=None, return_path_domain=None):
        ...
        Args:
           ...
           to (array|null): optionally define the recipients to receive the message - otherwise we'll use the To, Cc, and Bcc headers provided in the document::
               to[] (string): the email address of the recipient
           async_bool (boolean): enable a background sending mode that is optimized for bulk sending. In async_bool mode, messages/sendRaw will immediately return a status of "queued" for every recipient. To handle rejections when sending in async_bool mode, set up a webhook for the 'reject' event. Defaults to false for messages with no more than 10 recipients; messages with more than 10 recipients are always sent async_boolhronously, regardless of the value of async_bool.
           ip_pool (string): the name of the dedicated ip pool that should be used to send the message. If you do not have any dedicated IPs, this parameter has no effect. If you specify a pool that does not exist, your default pool will be used instead.
        ...
        Raises:
           ...
           Error: A general Mandrill error has occurred
        """
        _params = {'raw_message': raw_message, 'from_email': from_email, 'from_name': from_name, 'to': to, 'async_bool': async_bool, 'ip_pool': ip_pool, 'send_at': send_at, 'return_path_domain': return_path_domain}
...
class Metadata(object):
    ...
    def delete(self, name):
        """Delete an existing custom metadata field. Deletion isn't instataneous, and /metadata/list will continue to return the field until the async_boolhronous deletion process is complete.
